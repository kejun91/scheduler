...
import random
import string
from app.storage.sqlite.database.db import DB
from app.storage.sqlite.sql.pragma import table_info
from app.storage.sqlite.table.column import Column, Constraint, DataType, Default, ForeignKey, Index
from app.storage.sqlite.table.column_enum import ID, LAST_MODIFIED_DATE, SystemColumn
...
def create_model_class(base_class:SqliteDynamicModel, database_name):
