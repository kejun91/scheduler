...
from app.storage.sqlite.database.common import get_max_variable_number
from app.storage.sqlite.database.session import Session
from app.storage.sqlite.table.column_enum import ID
from app.storage.sqlite.table.model import SqliteDynamicModel, SqliteModel
from app.utils.common import CustomEncoder, split_list_into_batches
...
def convert_value(v):
    if isinstance(v, bool):
        ...
        return json.dumps(v, cls=CustomEncoder)
    elif isinstance(v, ConditionBase):
